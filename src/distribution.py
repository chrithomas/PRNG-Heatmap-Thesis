# written by: https://github.com/chrithomas
...
for n in range(numIterations):
    ...
    if n == numIterations - 1: plt.savefig('heatmaps/'+ str(ALGORITHM) + '_' + str(numCandidates) + 'x' + str(numIterations) + 'x' + str(numValsPerIter) + '_dist_HM_FINAL_FRAME.svg')
    plt.close()
